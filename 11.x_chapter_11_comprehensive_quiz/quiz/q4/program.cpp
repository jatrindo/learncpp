 ...
 * quiz question. First, create private members to hold the rank and suit (name
 * them m_rank and m_suit accordingly). Second, create a public constructor for
 * the Card class so we can initialize Cards. Third, make the class default
 * constructible, either by adding a default constructor or by adding default
 * arguments to the current constructor. Finally, move the printCard() and
 * getCardValue() functions inside the class as public members (remember to make
 * them const!).
*/
#include <algorithm>
#include <array>
